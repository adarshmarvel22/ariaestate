...
class HTMXCategoryDeleteView(generic.DeleteView):
    model = models.Category
    success_url = reverse_lazy("properties_Category_htmx_list")
...
class HTMXLeaseListView(generic.ListView):
    model = models.Lease
...
class HTMXLeaseCreateView(generic.CreateView):
    model = models.Lease
    form_class = forms.LeaseForm
...
class HTMXLeaseDeleteView(generic.DeleteView):
    model = models.Lease
    success_url = reverse_lazy("properties_Lease_htmx_list")
...
class HTMXProjectDeleteView(generic.DeleteView):
    model = models.Project
    success_url = reverse_lazy("properties_Project_htmx_list")
...
class HTMXUnitDeleteView(generic.DeleteView):
    model = models.Unit
    success_url = reverse_lazy("properties_Unit_htmx_list")
