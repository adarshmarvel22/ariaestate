...
class HTMXProfileListView(generic.ListView):
...
class HTMXProfileCreateView(generic.CreateView):
    model = models.Profile
    form_class = forms.ProfileForm
...
class HTMXProfileDeleteView(generic.DeleteView):
    model = models.Profile
    success_url = reverse_lazy("accounts_Profile_htmx_list")
...
class HTMXRoleListView(generic.ListView):
    model = models.Role
...
class HTMXRoleCreateView(generic.CreateView):
    model = models.Role
    form_class = forms.RoleForm
...
class HTMXRoleDeleteView(generic.DeleteView):
    model = models.Role
    success_url = reverse_lazy("accounts_Role_htmx_list")
...
class HTMXUserDeleteView(generic.DeleteView):
    model = models.User
    success_url = reverse_lazy("accounts_User_htmx_list")
